...
class _$CustomerImpl implements _Customer {
  ...
  @override
  String toString() {
    return 'Customer(id: $id, name: $name, phone: $phone, email: $email, address: $address, taxNumber: $taxNumber, taxOffice: $taxOffice, notes: $notes, isActive: $isActive, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, phone, email, address,
      taxNumber, taxOffice, notes, isActive, createdAt);
