...
abstract class $UnitModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String symbol, int sortOrder});
}
...
class _$UnitModelImpl implements _UnitModel {
  ...
  @override
  String toString() {
    return 'UnitModel(id: $id, name: $name, symbol: $symbol, sortOrder: $sortOrder)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, symbol, sortOrder);
...
abstract class _UnitModel implements UnitModel {
  const factory _UnitModel(
      ...
      final String symbol,
      final int sortOrder}) = _$UnitModelImpl;
